MovieTickets.userAccount = (function () {
    ...
    var viewModel = kendo.observable({
        ...
        firstName: "",
        lastName: "",
        userName: $("#user-acc-username").value, //hardcoded
        password: $("#user-acc-password").value, //hardcoded
        userAddress: "",
        userEmailAddress: "",
        ...
        fnLoginCallBack: function (result) {
            if (result.success === true) {
                ...
                viewModel.set("userBranchs",result.data.Branchs);
        ...
        logOff: function () {
            ...
            viewModel.set("userBranchs", "");
            viewModel.set("userSelectBranch","");
